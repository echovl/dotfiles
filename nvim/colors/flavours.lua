...
hi.TSConstructor        = { guifg = M.colors.base0A, guibg = nil, gui = 'none',          guisp = nil }
...
hi.TSField              = { guifg = M.colors.base09, guibg = nil, gui = 'none',          guisp = nil }
...
hi.TSLabel              = { guifg = M.colors.base08, guibg = nil, gui = 'none',          guisp = nil }
...
hi.TSParameter          = { guifg = M.colors.base09, guibg = nil, gui = 'none',          guisp = nil }
hi.TSParameterReference = { guifg = M.colors.base09, guibg = nil, gui = 'none',          guisp = nil }
